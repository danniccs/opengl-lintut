...
void Shader::initVals(const char* vertexPath, const char* fragmentPath, const char* geometryPath) {
...
void Shader::setLightDir(const Light& light, const glm::mat3& dirNormMatrix) const {
	try {
		std::array<int, 2> IDs = lightIDs.at(light.name);
